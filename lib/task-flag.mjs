...
export class TaskFlag {
    ...
    */
    ...
    /**
     * @returns { RepeatNoResponseTaskFlag }
    */
    static get RepeatNoResponse() {
        return repeatNoResponse;
    }
    /**
...
export class RepeatNoResponseTaskFlag extends TaskFlag { constructor() { super(crypto.randomUUID(), TaskFlagGroup.Run); } }
...
const repeatNoResponse = new RepeatNoResponseTaskFlag();
