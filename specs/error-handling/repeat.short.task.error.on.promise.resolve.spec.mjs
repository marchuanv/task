...
const suite = describe('when a repeated short task results in an error on a promise resolve', () => {

    let promise;
    beforeAll(async () => {
        promise = TestTask.create(suite, 'ShortTaskRepeatedErrorOnPromiseResolve', [TaskFlag.RepeatWithOutput]).run(0, async function () {
