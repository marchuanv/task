...
const suite = describe('when a repeated long task is resolved with null given an error', () => {

    let promise;
    beforeAll(async () => {
        promise = TestTask.create(suite, 'LongTaskRepeatedDataResolvedWithNull', [TaskFlag.RepeatDataResolve]).run(0, async function () {
