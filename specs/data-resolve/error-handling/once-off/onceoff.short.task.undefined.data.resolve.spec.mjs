...
const suite = describe('when a once-off short task is resolved with undefined given an error', () => {

    let promise;
    beforeAll(async () => {
        promise = TestTask.create(suite, 'LongTaskOnceOffResolvedWithUndefined', [TaskFlag.OnceOffDataResolve]).run(0, async function () {
